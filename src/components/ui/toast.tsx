...
const toastVariants = cva(
    ...
    'rounded-md border p-4 pr-6 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 ' +
...
>(({ className, ...props }, ref) => (
    <ToastPrimitives.Action
        ...
        className={cn(
            ...
            'font-medium transition-colors hover:bg-secondary focus:outline-none focus:ring-1 focus:ring-ring' +
